  ...
  <div class="container">
    <div class="slider-container">
      <div class="intro-text">
        ...
        <a style="margin-right:10px;"href="mngAct.php" class="page-scroll btn btn-xl">Manage-Show Accounts</a>
        <a href="adashboard.php?update=success" class="page-scroll btn btn-xl">Upate Website</a>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="col-md-3"> </div>
    <div class="col-md-9">
          ...
          if (strpos($fullUrl, "update=success") == true) {
            echo "<script> alert('Site Under Maintainance-Keep Patience :)')</script>";
          }
         ?>
    </div>
</div>

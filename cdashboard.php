  ...
  <div class="container">
    <div class="slider-container">
      <div class="intro-text">
        ...
        <a style="margin-right:10px;"href="searchCandy.php" class="page-scroll btn btn-xl">Search Candidates</a>
        <a href="vacancy.php" class="page-scroll btn btn-xl">Post A Vacancy</a>
      </div>
    </div>
  </div>
</header>
